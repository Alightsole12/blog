...
App.post('/blog/subscribe', (req,res) => {
	...
	const mailOptions = {
		...
		html: `Copy the link below into your browser to confirm your subscription or click <a href="http://taiznet.herokuapp.com/subscribe?action=confirm&code=${confirmationCode}">here</a>`
	};
